...
use crate::{
    ...
    domain::value_objects::cash_flow::{RecordCashFlowModel, RecordCashFlowWithDateModel},
};

#[derive(Clone)]
pub struct CashFlowMCPHandler {
    cash_flow_use_case: Arc<CashFlowUseCase>,
}

#[tool(tool_box)]
impl CashFlowMCPHandler {
    pub fn new(cash_flow_use_case: Arc<CashFlowUseCase>) -> Self {
        Self { cash_flow_use_case }
    }
...
#[tool(tool_box)]
impl ServerHandler for CashFlowMCPHandler {
